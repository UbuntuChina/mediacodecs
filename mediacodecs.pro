...
UBUNTU_TRANSLATION_DOMAIN="mediacodecs.liu-xiao-guo"
...
aptest.commands = bash $$PWD/mediacodecs/tests/autopilot/run
aptest.depends  = sub-mediacodecs

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/mediacodecs/tests/unit
unittest.depends  = sub-mediacodecs
